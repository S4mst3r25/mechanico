...
export default function Viewer({ modelPath, modelId }) {
    ...
    return (
        <>
            <div className="flex flex-col space-y-2 absolute right-5 top-[94px] z-20">
                <div className="bg-zinc-800 p-2 w-[380px] text-center text-white">
                    <h1 className="font-bold text-2xl">{t('library.models.' + modelId)}</h1>
                </div>
                <div className="bg-white w-[380px] text-center h-min shadow-md">
